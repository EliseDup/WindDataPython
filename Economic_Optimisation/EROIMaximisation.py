...
def main():
    inputs_params =  'inputs/inputs_params_sf' #Calculation.inputs_params 
    #results_maximiseEROICell(inputs_params, 'eroi_params_cell', True, 0, 10)
    results_maximiseEROIGrid(inputs_params, 'eroi_params_grid', False, 0, 1000)
